      ...
      <div>
        <div id="control-panel">
          <div className="app-title">
            <h3 style={{marginTop:'10px'}}>PITF Heat Map</h3>
            <p style={{margin:'0 10px 14px 10px'}}> Data sets from the 
              <a href="http://eventdata.parusanalytics.com/data.dir/atrocities.html" target="_blank">
                Political Instability Task Force Worldwide Atrocities Dataset </a> rendered 
